...
public class Mail {
    ...
    private final String companyEmail = "THE EMAIL SHOULD BE HERE"; //company email
    private final String companyPassword = "THE PASSWORD SHOULD BE HERE"; //email password
