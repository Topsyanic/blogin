<%-- 
    Document   : BloggerHomePage
    Created on : Dec 9, 2020, 9:16:40 AM
...
<html lang="en">
    ...
    <body>
        ...
        <c:url var="view" value="BloggerController">
            ...
            <c:forEach var="post" items="${TRENDING}">
                <div class="trendingCards">
                    ...
                    <c:url var="readmore" value="BloggerController">
                        ...
                        <%-- <c:param name="username" value='<%=session.getAttribute("username")%>'/> --%>
                    </c:url>  
                    ...
                    <%--     <% LikeDao ld = new LikeDao(Database.getConnection());%>     
                        <c:url var="liked" value="LikeServlet">
                            ...
                            <c:param name="blogId" value="<%= String.valueOf('1')%>"/>
                        </c:url>
                        <a href="homepage.jsp" class="btn btn-light" href="${liked}">
                           <% if (ld.isLikedByUser(Integer.parseInt(request.getParameter("blogId")),(session.getAttribute("username")))) {%>
